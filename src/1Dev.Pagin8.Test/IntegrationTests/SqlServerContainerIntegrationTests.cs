...
/// <summary>
/// Integration tests for SQL Server using Testcontainers
/// Tests all DSL features against a real SQL Server database running in Docker
/// </summary>
...
public class SqlServerContainerIntegrationTests
{
    ...
    public SqlServerContainerIntegrationTests(SqlServerContainerFixture fixture, ITestOutputHelper output)
    {
        _fixture = fixture;
        _output = output;
    ...
    [Fact(DisplayName = "TC-SQL-001: Equality (eq) - Filter by exact status")]
    ...
    [Fact(DisplayName = "TC-SQL-002: Greater Than (gt) - Filter by price > 500")]
    ...
    [Fact(DisplayName = "TC-SQL-003: Less Than (lt) - Filter by stock < 100")]
    ...
    [Fact(DisplayName = "TC-SQL-004: Greater Than or Equal (gte)")]
    ...
    [Fact(DisplayName = "TC-SQL-005: Less Than or Equal (lte)")]
    ...
    [Fact(DisplayName = "TC-SQL-006: Contains (cs) - Search in product name")]
    ...
    [Fact(DisplayName = "TC-SQL-007: Starts With (stw)")]
    ...
    [Fact(DisplayName = "TC-SQL-008: Ends With (enw)")]
    ...
    [Fact(DisplayName = "TC-SQL-009: LIKE Pattern")]
    ...
    [Fact(DisplayName = "TC-SQL-010: Date Range (gte/lte)")]
    ...
    [Fact(DisplayName = "TC-SQL-011: Relative Date - Last 30 Days")]
    ...
    [Fact(DisplayName = "TC-SQL-012: Multiple AND Conditions")]
    ...
    [Fact(DisplayName = "TC-SQL-013: OR Group")]
    ...
    [Fact(DisplayName = "TC-SQL-014: Complex OR with AND")]
    ...
    [Fact(DisplayName = "TC-SQL-015: IN Operator (Strings)")]
    ...
    [Fact(DisplayName = "TC-SQL-016: NOT IN Operator")]
    ...
    [Fact(DisplayName = "TC-SQL-017: Sort by Price (Ascending)")]
    ...
    [Fact(DisplayName = "TC-SQL-018: Sort by Rating (Descending)")]
    ...
    [Fact(DisplayName = "TC-SQL-019: Multi-column Sort")]
    ...
    [Fact(DisplayName = "TC-SQL-020: Boolean Filter (Featured Products)")]
    ...
    [Fact(DisplayName = "TC-SQL-021: E-commerce: Find Budget Electronics")]
    ...
    [Fact(DisplayName = "TC-SQL-022: E-commerce: Premium Featured Products")]
    ...
    [Fact(DisplayName = "TC-SQL-023: Inventory: Low Stock Alert")]
    ...
    [Fact(DisplayName = "TC-SQL-024: Marketing: New High-Rated Products")]
    ...
    [Fact(DisplayName = "TC-SQL-025: Sales: Multi-Category Popular Items")]
    public async Task ComplexQuery_MultiCategoryPopular()
    {
        var result = await ExecuteQuery("category=in.(Electronics,Books,Sports)&rating=gt.4.0&stock=gt.100&isFeatured=eq.true&paging=(sort(rating.desc,price.asc),limit.20)");
        
        result.Should().NotBeEmpty();
        result.All(p => p.Rating > 4.0 && p.Stock > 100 && p.IsFeatured).Should().BeTrue();
        _output.WriteLine($"? Found {result.Count} popular items across categories");
    }
